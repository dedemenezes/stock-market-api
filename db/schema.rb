...
ActiveRecord::Schema.define(version: 2021_07_08_035204) do
  ...
  create_table "bearers", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_bearers_on_user_id"
  end
  ...
  create_table "stocks", force: :cascade do |t|
    ...
    t.bigint "market_price_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  add_foreign_key "stocks", "market_prices"
end
